...
import { LayoutDashboard, Users, KanbanSquare, BarChart3, Inbox, Sparkles, LogOut, GraduationCap, CalendarClock, UserCog, Settings as SettingsIcon, Bot, Mail } from "lucide-react";
...
const navItems = [
  ...
  { to: "/email", label: "Email Outreach", icon: Mail, testid: "nav-email" },
